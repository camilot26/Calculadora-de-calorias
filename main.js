...
function calcularCalorias() {
    ...
    if ( !(nombre.value&&edad.value && peso.value && altura.value) ) {
    ...
    <h5 class="card-title h2">NOMBRE DE LA PERSONA</h5>
    <div class="mb-3 w-100">
        <input class="form-control text-center" value="${nombre.value} " style="font-size: 2rem" disabled>
    </div

        <h5 class="card-title h2">Calorías requeridas</h5>
        <div class="mb-3 w-100">
            <input class="form-control text-center" value="${Math.floor(calculoCalorias)} kcal  para el sostenimiento de su TBM" style="font-size: 2rem" disabled>
        </div>
    </div>  
`
    nombre.value=null;
